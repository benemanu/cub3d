...
/*   Updated: 2023/03/15 11:40:59 by shoffman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_load_img_reload_message(t_info *info, char *img)
{
	info->game.reload.img = mlx_xpm_file_to_image(info->mlx, img,
			&info->game.reload.dimensions.sprite_width, &info->game.reload.dimensions.sprite_height);
	info->game.reload.data = mlx_get_data_addr(info->game.reload.img,
			&info->game.reload.dimensions.s_bpp, &info->game.reload.size_l,
